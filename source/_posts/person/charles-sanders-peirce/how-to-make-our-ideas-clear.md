...
The so-called "parallelogram of forces" is simply a rule for compounding accelerations.
...
In a recent admired work on Analytic Mechanics
...
It is noticeable that where different faiths flourish side by side,
