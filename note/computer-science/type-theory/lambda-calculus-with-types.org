...
*** assigning simple types
    ...
    this is where writing become hard,
    no metter top-down or bottom-up writing direction we use
...
*** simple properties and comparisons
    ...
    has unique proof (or the system is is "syntax directed")
    ...
    todo unicity of types

    in de bruijn

    todo unicity of types

*** [todo] comparing church style and curry style

    todo about neutral term

*** [todo] comparing church style and de bruijn style

*** [todo] comparing curry style and de bruijn style

*** [todo] the three systems compared
