...
- The monoid of terms is freely generated by symbols: `a b c d ...`
- The monoid of types is freely generated by symbols: `A B C D ...`
...
chosen from the lower case latin alphabets -- `a b c d ...`,
such as:
...
chosen from the upper case latin alphabets -- `A B C D ...`,
such as:
...
- We call this way of constructing new types **negation**.
  ...
  Note that this is NOT `A`'s inverse element in the monoid,
...
```
infer(let (x: A) ... x ...) = A neg infer(...) A infer(...)
```
