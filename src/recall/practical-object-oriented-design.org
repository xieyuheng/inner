...
- How to minimize the costs of creating a hierarchy?
  ...
  the best way to minimize these costs  is to maximize your chance of getting the abstraction right
...
- Can we can do this in the "record type + closure" style of OOP?
