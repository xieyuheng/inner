...
***** 1.4 disjoint union of a family of types
      ...
      (:= R [(: :x (-> Z -- Q))
             (-> (: :m :n Z)
              -- :m :n add :x apply :m :x apply sub abs
                 2 :m neg power LT)])
      #+end_src
...
*** >< 2 formalization of intuitionistic theory of types
...
***** MLTT71
      ...
      - was the first of type theories created by Per Martin-Löf.
        ...
        It had one universe but this universe had a name in itself,
...
***** MLTT73
      ...
      - There are identity types which he calls "propositions"
        ...
        and the rest of the types is introduced
